...
const DUMMY_FOUND_ITEMS = [
  {
    ...
    keepLocation: '3-1반',
    status: '찾아감',
    description: '하얀색 필통, 안에 인덱스가 존재합니다.\n\n(찾은 친구의 소감)\n\n공부를 해야 하는 상황에서 필통을 잃어버려 매우 당황스러웠다. 예전 같았으면 필통을 찾기 위해 여러 교무실이나 교실을 직접 돌아다니며 확인해야 해서 시간도 오래 걸리고 번거로웠을 것 같다. 하지만 이번 분실물 찾아주기 프로젝트에서는 학교 곳곳에 흩어져 있던 분실물 정보를 한 번에 확인할 수 있어서 내가 잃어버린 필통을 더 빠르게 찾을 수 있었다. 덕분에 불필요하게 여러 장소를 찾아다니는 시간을 줄일 수 있었고, 다시 공부에 집중할 수 있어 안심되었다.',
    image: './images/pencil_case.jpg',
    createdAt: new Date('2026-07-10T16:50:00').toISOString()
  },
  {
    id: 'f-12',
    title: '에어팟 한쪽',
    ...
    keepLocation: '3-6반',
    status: '찾아감',
    description: '에어팟 한쪽\n\n(찾은 소감)\n\n에어팟 한쪽을 잃어버렸을 때는 크기가 작기도 하고 이동수업을 하기에 다시 찾기 어려울 것 같다는 생각이 먼저 들었다. 기존에는 누군가가 주워도 어느 교무실이나 교실에 맡겨졌는지 알기 어려워 직접 여러 곳을 확인해야 했고, 작은 물건이라 찾는 과정이 더 막막하게 느껴졌다. 하지만 이번 분실물 찾아주기 프로젝트를 통해 학교 곳곳에 있던 분실물 정보를 한 번에 확인할 수 있었고, 그 덕분에 잃어버린 에어팟을 다시 찾을 수 있었다. 특히 한쪽만 없어져도 사용이 불편하고 새로 구매해야 하는 부담이 생길 수 있었는데, 프로젝트 덕분에 불필요한 경제적 손실을 줄일 수 있어 다행이라고 느꼈다.',
    image: './images/airpod_single.jpg',
    createdAt: new Date('2026-07-10T16:45:00').toISOString()
  },
  {
    id: 'f-1',
    title: '에어팟 프로 2세대 (흰색)',
